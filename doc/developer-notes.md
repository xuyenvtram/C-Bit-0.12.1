...
C-Bit Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as C-Bit Core, where everyone uses
...
pay attention to for reviewers of C-Bit Core code.
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: C-Bit Core uses tinyformat, which is type safe. Leave them out to avoid confusion
