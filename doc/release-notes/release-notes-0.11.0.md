C-Bit Core version 0.11.0 is now available from:
...
Block pruning allows C-Bit Core to delete the raw block and undo data once 
...
block index and UTXO databases. The minimum was chosen so that C-Bit Core will 
