...
If you are building `bitcoind` or `C-Bit Core` for others, your build machine should be set up
...
Once dependencies are compiled, see [doc/release-process.md](release-process.md) for how the C-Bit Core
